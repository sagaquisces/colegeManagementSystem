   ...
   <body>
      ...
      <div class="w3-container">
         <div class="w3-card-4 w3-margin-top">
            ...
            <form:form action="process" class="w3-container" modelAttribute="student" method="POST">
               ...
               <p>
                  <form:input class="w3-input" path="email" type="email" name="email" placeholder="Email"/>
               </p>
               <p>
               ...
               <p><a href="${pageContext.request.contextPath}/student/list">Return to student list</a></p>
            </form:form>
